...
const archetypeOptions: Array<[CosmicCreatureArchetype, string]> = [
  ...
  ['CONTROLLER', 'Controlador de campo'], ['ARTILLERY', 'Artilharia à distância'], ['SWARM', 'Enxame'], ['BOSS', 'Entidade dominante']
];

const originOptions: Array<[CosmicCreatureOrigin, string]> = [
  ['RANDOM', 'Origem aleatória'], ['FERIDA', 'A Ferida'], ['VAZIO', 'O Vazio'], ['SONHO', 'O Sonho'],
  ['CRISTAL', 'Cristal impossível'], ['TEMPO', 'Tempo quebrado'], ['PARASITA', 'Parasita extraplanar'], ['ABISMO', 'O Abismo']
];
