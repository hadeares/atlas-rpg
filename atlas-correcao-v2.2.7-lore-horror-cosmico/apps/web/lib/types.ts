...
export type CosmicCreatureArchetype = 'RANDOM' | 'STALKER' | 'BRUTE' | 'CONTROLLER' | 'ARTILLERY' | 'SWARM' | 'BOSS';
export type CosmicCreatureOrigin = 'RANDOM' | 'FERIDA' | 'VAZIO' | 'SONHO' | 'CRISTAL' | 'TEMPO' | 'PARASITA' | 'ABISMO';
